...
import com.isaac.pokedex_clone.databinding.ItemFavouritePokemonBinding
import com.isaac.pokedex_clone.utils.loadImageUrl

private object FavouritePokemonDiffItemCallBack : DiffUtil.ItemCallback<Pokemon>() {
...
class FavouritePokemonAdapter(val fragment: Fragment) :
    ListAdapter<Pokemon, FavouritePokemonAdapter.ItemViewHolder>(FavouritePokemonDiffItemCallBack) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder =

        ItemViewHolder(ItemFavouritePokemonBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    ...
    inner class ItemViewHolder(
        private val binding: ItemFavouritePokemonBinding,
        ...
        fun bind(item: Pokemon, position: Int) {
            ...
            binding.root.setOnClickListener {
                val directions = FavouriteFragmentDirections.actionFavFragmentToDetailFragment(
